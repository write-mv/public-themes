...
namespace WriteMv\Themes\Console;
...
final class PublishCommand extends Command
{
     ...
     * @var string
     */
    protected $signature = 'themes:publish {component}
    ...
    public function handle(Filesystem $filesystem): int
    {
        ...
        if ($this->option('class') || ! $this->option('view')) {
            ...
            if ($filesystem->missing($config = $this->laravel->configPath('themes.php'))) {
                $this->call('vendor:publish', ['--tag' => 'themes-config']);
            }
